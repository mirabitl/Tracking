...
public:
  ...
  inline void setCalibrationInfos(uint32_t runtype,uint32_t vth,uint32_t gain){_runType=runtype;_vthSet=vth;_gainSet=gain;}
  ...
  inline int32_t gain(){return _gainSet;}


private:
  uint32_t _run,_event,_gtc,_runType,_vthSet,_gainSet;
  uint64_t _abcid;
